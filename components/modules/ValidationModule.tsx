...
const ValidationModule: React.FC = () => {
    ...
    const [accuracyResults, setAccuracyResults] = useState<AccuracyBenchmark[] | null>(null);
    ...
    const runAccuracyValidation = async () => {
        ...
        setAccuracyResults([...benchmarkHistory, newBenchmarkRun]);
                                    ...
                                    <div className="w-full h-48">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <LineChart data={accuracyResults} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
                                                ...
                                                <Line type="monotone" dataKey="precision" stroke="var(--color-green-bright)" strokeWidth={2} />
                                                <Line type="monotone" dataKey="recall" stroke="var(--color-data-blue)" strokeWidth={2} />
                                                <Line type="monotone" dataKey="f1" stroke="var(--color-warning)" strokeWidth={2} />
                                            </LineChart>
                                        </ResponsiveContainer>
                                    </div>
                                </div>
