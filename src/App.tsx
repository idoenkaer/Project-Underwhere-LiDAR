...
import { QuickActionsToolbar } from './components/common/QuickActionsToolbar';
...
const AppContent: React.FC = () => {
  ...
  const themeClasses = `${isHighContrast ? 'theme-high-contrast' : ''} ${reduceMotion ? 'motion-reduced' : ''} ${fontSizeClass}`;
       ...
       {!showEthicsSplash && !showOnboarding && (
         <>
            <button
                ...
                className="fixed bottom-6 right-6 z-40 p-4 bg-green-bright text-bg-primary rounded-full shadow-lg hover:bg-green-primary transition-transform hover:scale-110 hidden md:flex"
