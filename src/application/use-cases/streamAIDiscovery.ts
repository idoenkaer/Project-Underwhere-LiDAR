...
Your response MUST be formatted in markdown and begin with a metadata block that is clearly separated by '---'. The report MUST include the following sections:

### Analysis Metadata
- **Primary Model:** GeoSeg-v2.2.0
- **Language Model:** Gemini-2.5-Flash
- **Key Parameters:** {segmentation_threshold: 0.7, confidence_min: 80%}
- **Overall Confidence:** [A percentage between 80% and 98%]
- **Uncertainty Score:** [A percentage that is 100 minus the confidence score]
---
...
5.  **Model & Data Citations:** Include a section citing the simulated models and data sources used (e.g., "Segmentation Model: GeoSeg-v2.2.0", "Data Source: USGS 3DEP Lidar").
