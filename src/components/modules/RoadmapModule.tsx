                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-bg-secondary p-6 rounded-sm border border-green-dark">
                        ...
                        <ul className="space-y-6">
                            ...
                            <StageItem icon={BeakerIcon} title="3. Automated Testing" description="Unit, integration, and domain-specific scientific validation checks are run to prevent regressions and ensure accuracy." tools="Vitest, React Testing Library" />
                            <StageItem icon={ArchiveBoxIcon} title="4. Build & Package" description="The application is bundled into a static build, ready for deployment." tools="Vite, TypeScript Compiler" />
